...
final class BasicMarkersTests: XCTestCase {
    ...
    func testBasicMarkers_extractMarkers() throws {
        ...
        XCTAssertEqual(marker0.roles, .init(video: "Titles", isVideoDefault: true, audio: nil, isAudioDefault: false))
        ...
        XCTAssertEqual(marker1.roles, .init(video: "Titles", isVideoDefault: true, audio: nil, isAudioDefault: false))
        ...
        XCTAssertEqual(marker2.roles, .init(video: "Titles", isVideoDefault: true, audio: nil, isAudioDefault: false))
        ...
        XCTAssertEqual(marker3.roles, .init(video: "Titles", isVideoDefault: true, audio: nil, isAudioDefault: false))
