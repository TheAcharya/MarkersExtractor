...
final class BasicMarkersTests: XCTestCase {
    ...
    func testBasicMarkers_extractMarkers() throws {
        ...
        XCTAssertEqual(marker0.roles, .init(video: "Titles", audio: nil))
        ...
        XCTAssertEqual(marker1.roles, .init(video: "Titles", audio: nil))
        ...
        XCTAssertEqual(marker2.roles, .init(video: "Titles", audio: nil))
        ...
        XCTAssertEqual(marker3.roles, .init(video: "Titles", audio: nil))
